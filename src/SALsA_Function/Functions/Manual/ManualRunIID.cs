...
namespace SALsA.Functions
{
    public static class ManualRunIIDGet
    {
        ...
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "manual/ManualRunIID")] HttpRequestMessage req, ExecutionContext context,
            ILogger log)
        {
    ...
    public static class ManualRunIIDPost
    {
        ...
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "manual/ManualRunIID")] HttpRequestMessage req, ExecutionContext context,
            ILogger log)
        {
            log.LogInformation($"C# HTTP trigger function {0} processed a request.", context.FunctionName);
