...
namespace LivesiteAutomation
{
    ...
    { 
        private class GenevaAction
        {
            ...
            internal GenevaAction(string extensionName, string operationName, Dictionary<string, string> actionParam, ActionsEnvironments actionsEnvironments = ActionsEnvironments.Public)
            {
                try
                {
            ...
            public async Task<Stream> GetOperationFileOutputAsync()
            {
                try
                {
