...
namespace LivesiteAutomation
{
    ...
    {
        // CRP global
        public readonly static string[] CRPRegions = { "AustraliaCentral", "AustraliaCentral2", "AustraliaEast", "AustraliaSouthEast", "BrazilSouth", "CanadaCentral", "CanadaEast", "CentralIndia", "CentralUS", "CentralUSEUAP", "ChinaEast", "ChinaEast2", "ChinaNorth", "ChinaNorth2", "EastAsia", "EastUS", "EastUS2", "EastUS2Euap", "EastUS2EUAP", "FranceCentral", "FranceSouth", "GermanyCentral", "GermanyNorth", "GermanyNortheast", "GermanyWestCentral", "JapanEast", "JapanWest", "KoreaCentral", "KoreaSouth", "NorthcentralUS", "NorthCentralUS", "NorthEurope", "NorwayEast", "NorwayWest", "SouthAfricaNorth", "SouthAfricaWest", "SouthcentralUS", "SouthCentralUS", "SoutheastAsia", "SouthEastAsia", "SouthIndia", "Staging (westus2)", "Staging%20(westus2)", "SwitzerlandNorth", "SwitzerlandWest", "UAECentral", "UAENorth", "UKNorth", "UKSouth", "UKSouth2", "UKWest", "USDoDCentral", "USDoDEast", "USGovArizona", "USGovIowa", "USGovTexas", "USGovVirginia", "WestcentralUS", "WestCentralUS", "WestEurope", "WestIndia", "WestUS", "WestUS2", "WestUSValidation" };
