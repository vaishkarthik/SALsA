...
{
    public class ManualRunRdfeFabricController : ApiController
    {
        ...
        public bool Post(HttpRequestMessage request)
        {
            ...
            var obj = LivesiteAutomation.Utility.JsonToObject<LivesiteAutomation.ManualRun.ManualRun_RDFE_Fabric>(
