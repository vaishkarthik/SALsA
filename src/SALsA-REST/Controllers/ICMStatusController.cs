...
namespace SALsA_REST.Controllers
{
    public class ICMStatusController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            string template = "<!DOCTYPE html><html><body><h2>SALsA Status</h2><table style=\"width:50%\" align=\"center\" >  <tr style=\"padding-left:30px;\" align=\"left\">    <th>ICM</th>    <th>Status</th>   </tr>  __INSERT__</table></body></html>";
